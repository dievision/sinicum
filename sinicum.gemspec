...
Gem::Specification.new do |s|
  ...
  s.summary     = %q(Use Magnolia as a CMS backend in a Rails app)
  s.description = %q(Provides the necessary functionality to
    work with Magnolia-managed content in a Rails app.)
